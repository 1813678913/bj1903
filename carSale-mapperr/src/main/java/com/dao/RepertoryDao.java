...
public interface RepertoryDao{
	 ...
	 * @return
	 */
    int updateRepertory(@Param("enti") Repertory value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyRepertory(@Param("enti") Repertory value, @Param("assist") Assist assist);
}