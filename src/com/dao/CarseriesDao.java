...
public interface CarseriesDao{
	 ...
	 * @return
	 */
    int updateCarseries(@Param("enti") Carseries value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyCarseries(@Param("enti") Carseries value, @Param("assist") Assist assist);
}